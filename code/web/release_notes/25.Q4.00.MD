...
- Fixed an issue where records without 245$a field would fail to display when attempting to build citations. (DIS-1444) (*LS*)
- Fixed miscellaneous PHP warnings related to ShareIt and InnReach. (DIS-1368) (*LS*)
- Use overall Email Results To field if no home library emails are specified. (DIS-1457) (*MDN*)
- Increase length of Email Result To Field to 250 characters custom forms for both default and library specific value. (DIS-1457) (*MDN*)
