...
- Add interface for creating native events, event types, event field sets, and event fields.  Events have an event type that determines which configurable field set they use. (DIS-192) (*KP*)
...
#### New Settings
- Events > Event Fields
- Events > Event Field Sets
- Events > Event Types
- Events > Events
- Events > Indexing Settings
