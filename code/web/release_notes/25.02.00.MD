...
- Added `$usageByUserAgent->find(true)` before incrementing request counters. (DIS-250) (*LS*)
- Added `$usageByIPAddress->find(true)` in various files before DB updates. (DIS-250) (*LS*)
