<div>
	<table class="table table-striped">
		<thead>
		<tr>
			<th{if empty($useNote)} colspan="2"{/if}>{translate text="Date & Time" isPublicFacing=true}</th>
		...
		<tr style="vertical-align: middle">
			<th scope="row" style="width: 25%; word-wrap: break-word"{if empty($useNote)} colspan="2"{/if}>
				<h4 style="margin: 0">
			...
			{if !empty($useNote)}<td style="width: 40%; word-wrap: break-word">
